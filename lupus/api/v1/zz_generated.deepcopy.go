...
func (in *Element) DeepCopyInto(out *Element) {
	*out = *in
	if in.ObserveSpec != nil {
		in, out := &in.ObserveSpec, &out.ObserveSpec
		*out = new(ObserveSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.DecideSpec != nil {
		in, out := &in.DecideSpec, &out.DecideSpec
		*out = new(DecideSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.LearnSpec != nil {
		in, out := &in.LearnSpec, &out.LearnSpec
		*out = new(LearnSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.ExecuteSpec != nil {
		in, out := &in.ExecuteSpec, &out.ExecuteSpec
		*out = new(ExecuteSpec)
		(*in).DeepCopyInto(*out)
	}
}
