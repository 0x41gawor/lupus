...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MoveCommand) DeepCopyInto(out *MoveCommand) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MoveCommand.
func (in *MoveCommand) DeepCopy() *MoveCommand {
	if in == nil {
		return nil
	}
	out := new(MoveCommand)
